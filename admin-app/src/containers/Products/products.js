        ...
        <Modal.Body>
          ...
          <Row>
            <Col md="4">
              ...
              <p className="value">
                {productDetails.carOverview[0].manufacturedYear}
              </p>
            </Col>
            <Col md="4">
              <label className="key">Registration Year</label>
              <p className="value">{productDetails.carOverview[0].regYear}</p>
            </Col>
            <Col md="4">
              <label className="key">Fuel</label>
              <p className="value">{productDetails.carOverview[0].fuel}</p>
            </Col>
          </Row>
          ...
          <Row>
            <Col md="4">
              ...
              <p className="value">{productDetails.carOverview[0].kmsDriven}</p>
            </Col>
            <Col md="4">
              <label className="key">RTO</label>
              <p className="value">{productDetails.carOverview[0].rto}</p>
            </Col>
            <Col md="4">
              <label className="key">Engine Displacement</label>
              <p className="value">
                {productDetails.carOverview[0].engineDisplacement}
              </p>
            </Col>
          </Row>
          ...
          <Row>
            <Col md="4">
              ...
              <p className="value">
                {productDetails.carOverview[0].noOfOwners}
              </p>
            </Col>
            <Col md="4">
              <label className="key">Transmission</label>
              <p className="value">
                {productDetails.carOverview[0].transmission}
              </p>
            </Col>
            <Col md="4">
              <label className="key">Insurance Type</label>
              <p className="value">
                {productDetails.carOverview[0].insuranceType}
              </p>
            </Col>
          </Row>
          ...
          <Row>
            <Col md="4">
              ...
              <p className="value">
                {productDetails.inspectionReport[0].interiorDetails}
              </p>
            </Col>
            <Col md="4">
              <label className="key">Body & Frame</label>
              <p className="value">
                {productDetails.inspectionReport[0].bodyNframe}
              </p>
            </Col>
            <Col md="4">
              <label className="key">Engine & Transmission</label>
              <p className="value">
                {productDetails.inspectionReport[0].engineNtransmission}
              </p>
            </Col>
          </Row>
          <Row>
            <Col md="4">
              ...
              <p className="value">
                {productDetails.inspectionReport[0].electricals}
              </p>
            </Col>
            <Col md="4">
              <label className="key">Tyre</label>
              <p className="value">{productDetails.inspectionReport[0].tyre}</p>
            </Col>
            <Col md="4">
              <label className="key">Light</label>
              <p className="value">
                {productDetails.inspectionReport[0].light}
              </p>
            </Col>
          </Row>
          <Row>
            <Col md="4">
              ...
              <p className="value">
                {productDetails.inspectionReport[0].exteriorDetails}
              </p>
            </Col>
            <Col md="4">
              <label className="key">Other Details</label>
              <p className="value">
                {productDetails.inspectionReport[0].otherDetails}
              </p>
            </Col>
          </Row>
          ...
          <Row>
            <Col md="4">
              ...
              <p className="value">
                {productDetails.carSpecifications[0].mileage}
              </p>
            </Col>
            <Col md="4">
              <label className="key">Engine</label>
              <p className="value">
                {productDetails.carSpecifications[0].engine}
              </p>
            </Col>
            <Col md="4">
              <label className="key">Max Power</label>
              <p className="value">
                {productDetails.carSpecifications[0].maxPower}
              </p>
            </Col>
          </Row>
          ...
          <Row>
            <Col md="4">
              ...
              <p className="value">
                {productDetails.carSpecifications[0].torque}
              </p>
            </Col>
            <Col md="4">
              <label className="key">Wheel Size</label>
              <p className="value">
                {productDetails.carSpecifications[0].wheelSize}
              </p>
            </Col>
            <Col md="4">
              <label className="key">Seats</label>
              <p className="value">
                {productDetails.carSpecifications[0].seats}
              </p>
            </Col>
          </Row>
          ...
          <Row>
            <Col md="12">
              ...
              <p className="value">
                {productDetails.carFeatures[0].carComfort}
              </p>
            </Col>
          </Row>
          <Row>
            <Col md="12">
              ...
              <p className="value">{productDetails.carFeatures[0].carSafety}</p>
            </Col>
          </Row>
          <Row>
            <Col md="12">
              ...
              <p className="value">
                {productDetails.carFeatures[0].carInterior}
              </p>
            </Col>
          </Row>
          <Row>
            <Col md="12">
              ...
              <p className="value">
                {productDetails.carFeatures[0].carExterior}
              </p>
            </Col>
          </Row>
          <Row>
            <Col md="12">
              ...
              <p className="value">
                {productDetails.carFeatures[0].carEntertainment}
              </p>
            </Col>
          </Row>
        </Modal.Body>
